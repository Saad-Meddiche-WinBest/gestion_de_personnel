                        ...
                        <td>
                            <div style="display:flex; ">
                                ...
                                <form action="{{ route('affecterRole' ) }}" method="POST">
                                    @csrf
                                    <button id="btn1" type="submit" class="btn btn-success">Assign role of {{ choose_data($data1->{$column['name']}, $column) }}</button>
                                    <input type="hidden" name="role_id" value="{{ $data1->id}}">
                                </form>

                                <form action="{{ route('retirerRole' ) }}" method="POST">
                                    @csrf
                                    <button id="btn1" type="submit" class="btn btn-danger">Revoke role of {{ choose_data($data1->{$column['name']}, $column) }}</button>
                                    <input type="hidden" name="role_id" value="{{ $data1->id}}">
                                </form>
                                @endif
                            </div>
