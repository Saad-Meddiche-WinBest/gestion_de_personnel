...
@section('content')
    ...
    <div style="width:100%;">
    <button type="submit" class="btn btn-primary" style="float:right;  margin-bottom:15px; font-size:1.5vh; "><svg xmlns="http://www.w3.org/2000/svg" style="margin-right:20px"  width="16" height="16" fill="currentColor" class="bi bi-plus-circle-dotted" viewBox="0 0 16 16">
...
</svg>Add {{ ucfirst($name_of_model) }}</button></div>
